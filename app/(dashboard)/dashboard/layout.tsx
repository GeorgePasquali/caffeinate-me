  ...
  return (
    <div className="flex flex-col min-h-[calc(100dvh-68px)] max-w-7xl mx-auto w-full">
      ...
      <div className="flex flex-1 overflow-hidden h-full">
        {/* Sidebar */}
        <aside
          className={`w-64 bg-white dark:bg-gray-900 lg:bg-gray-50 dark:lg:bg-gray-900 border-r border-gray-200 dark:border-gray-800 lg:block ${
        ...
        {/* Main content */}
        <main className="flex-1 overflow-y-auto p-0 lg:p-4 bg-gray-50 dark:bg-gray-950">{children}</main>
      </div>
    </div>
  );
}
